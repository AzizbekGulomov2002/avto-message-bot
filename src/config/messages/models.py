...
class ScheduledMessage(models.Model):
    ...
    message_time = models.CharField(max_length=200, null=True, blank=True, help_text="Dynamic message time display (e.g., '5 daqiqa', 'Har 10 minutda')")
    duration_time = models.CharField(max_length=200, null=True, blank=True, help_text="Dynamic duration time display (e.g., '2025-11-08 12:55:02')")
...
class ScheduledMessageAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'user_id', 'interval_minutes', 'message_time', 'duration_time', 'paused', 'expires_at', 'created_at')
    list_filter = ('paused', 'created_at')
    search_fields = ('id', 'user_id', 'message', 'message_time', 'duration_time')
    ...
    fieldsets = (
        ...
        ('Dynamic Time Settings', {
            'fields': ('message_time', 'duration_time'),
            'description': 'These fields allow you to customize how time is displayed in the bot. Leave empty to use default values.'
        }),
    )
